                ...
                <div class="row justify-content-center">
                  <div class="col-sm-6">
                    <div class="picture-container">
                      <div class="picture">
                        <img src=".{{ asset('back/assets/img/default-avatar.png') }}" class="picture-src" id="wizardPicturePreview" title="" />
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="input-group form-control-lg">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInput6" name="lieu">
                      </div>
                    </div>                    
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="input-group form-control-lg">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="exampleInput3" name="email_tuteur">
                      </div>
                    </div>
                    <div class="input-group form-control-lg">
                      <div class="input-group-prepend">
                    ...
                    <div class="input-group form-control-lg">
                      ...
                      <div class="form-group select-wizard"> 
                        <select class="selectpicker" data-style="select-with-transition" title="Sexe_tuteur"> 
                          <option value="Homme"> Homme </option>
                          <option value="Femme"> Femme </option> 
                        </select> 
                      </div>
                ...
                <div class="row justify-content-center">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group select-wizard">
                      <label>Cycle</label>
                      <select class="selectpicker" data-size="7" data-style="select-with-transition" title="Single Select"> 
                        <option value="Albania"> Crèche </option>
                        <option value="Algeria"> Primaire </option> 
                        <option value="Algeria"> Collège </option> 
                        <option value="Algeria"> Lycée </option> 
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group select-wizard">
                      ...
                      <select class="selectpicker" data-style="select-with-transition" title="Modalité"> 
                  ...
                  <div class="col-sm-6">
                    <div class="input-group form-control">  
                        ...
                        <input type="number" class="form-control" id="exampleInput22" name=""> 
                    </div>
                  </div>
