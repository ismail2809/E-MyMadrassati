                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="{{ asset('landing/assets/images/logo.svg') }}" alt="Logo">
                            </a>
                ...
                <div class="col-lg-12">
                    <div class="brand-logo d-flex align-items-center justify-content-center justify-content-md-between">
                        <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <img src="{{ asset('landing/assets/images/brand-1.png') }}" alt="brand">
                        </div> <!-- single logo -->
                    ...
                    <div class="col-lg-12">
                        <div class="copyright d-sm-flex justify-content-between">
                            <div class="copyright-content">
                                <p class="text">Copyright 2020 <a href="#" rel="nofollow"> E-Madrassati </a> tous les droits sont résérvés.</p>
