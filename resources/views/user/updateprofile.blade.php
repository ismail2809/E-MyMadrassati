		          ...
		          <div class="col-lg-4">
		            <div class="form-group"> 
		              <select class="selectpicker" data-style="select-with-transition" name="sexe" title="Sexe"> 
		                <option value="Homme" {{ ( $data['users']['sexe'] == 'Homme') ? 'selected' : '' }}> Homme </option>
		                <option value="Femme" {{ ( $data['users']['sexe'] == 'Femme') ? 'selected' : '' }}> Femme </option> 
		              </select> 
		            </div>
		          </div> 
		          <div class="col-lg-4">
		            <div class="form-group"> 
		              <input type="text" class="form-control datepicker" name="ddn" value="{{ $data['users']['ddn']}}">
		            </div>
		          </div>
		          <div class="col-lg-4">
		            <div class="form-group">
